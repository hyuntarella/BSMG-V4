...
- [x] 30-PLAN.md — 미발송 카드 (경과일수 + 더보기 + UI 숨김)
- [x] 31-PLAN.md — 견적서 열람 고객 카드 (상대시간 + 추적 픽셀)
- [x] 32-PLAN.md — 연락해야 할 곳 카드 (성공확률 미배정 건)
- [x] 33-PLAN.md — 오늘 일정 + 견적서 불러오기 모달 + E2E 테스트 + 인증 우회
...
- [x] 36-PLAN.md — 이벤트 CRUD 모달 + 팀원 관리 + E2E 테스트
