...
const NAV_ITEMS = [
  ...
  { href: '/estimate/new', label: '견적서', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-2.5">
          ...
          <nav className="hidden items-center gap-1 sm:flex">
            {NAV_ITEMS.slice(0, 3).map(item => {
              const isActive = pathname === item.href || (item.href === '/estimate/new' && pathname.startsWith('/estimate'))
              return (
