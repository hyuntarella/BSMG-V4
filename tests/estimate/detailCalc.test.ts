  ...
  it('Case 1 — 12.png 재현 (품목 12개)', () => {
    const sheet: DetailSheet = {
      ...
      rows: [
        ...
        item('기존 바닥 돌뜸 부위 부분 제거', undefined, 500_000, 200_000),
        item('바탕조정제 부분미장', undefined, 800_000, 200_000),
        item('하도 프라이머', 297_000, 432_000),
        item('복합 시트', 3_970_000, 1_890_000, 135_000),
        ...
        item('판넬도막방수', undefined, 900_000, 300_000),
      ],
    }
