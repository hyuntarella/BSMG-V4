...
const DEFAULT_STT_PROMPT = '방수 복합 우레탄 견적 바탕정리 바탕조정제미장 복합시트 보호누름 우레탄도막 상도 탑코팅 벽체실링 하도 프라이머 노출 우레탄 사다리차 스카이차 폐기물처리 크랙보수 드라이비트하부절개 헤베 평 넣어 넘겨. 면적 487헤베. 벽체 87헤베. 복합 4만3천원. 우레탄 3만8천원. 150헤베 237헤베 320헤베 50평 100평. 3만5천 4만3천 3만8천 2만5천. 재료비 500원 노무비 1000원 경비 12만원. 바탕정리 500 1000. 사다리차 12만 2일.'
